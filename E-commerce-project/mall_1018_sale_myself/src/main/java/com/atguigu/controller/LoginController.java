...
public class LoginController {
	...
	// @RequestMapping(value = "/login_json", produces = "text/html; charset=UTF-8")
	// @ResponseBody
	// public Object login_json(T_MALL_USER_ACCOUNT user) {
	// T_MALL_USER_ACCOUNT loginuser = loginServer.Login(user);
	// if (loginuser != null) {
	// return "成功";
	// }
	// return "失败";
