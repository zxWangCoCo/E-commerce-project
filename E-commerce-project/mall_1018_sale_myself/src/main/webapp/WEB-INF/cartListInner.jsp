	...
	<div class="Cbox">
		<table class="table table-striped table-bordered table-hover">
		   ...
		   <c:forEach items="${list_cart }" var="cart">
		     <tr>
		        <td width="150px">${cart.shfxz}<input onchange="change_shfxz(this.checked,${cart.sku_id})"  type="checkbox" ${cart.shfxz=="1"?"checked":""} /> <img src="upload/image/${cart.shp_tp }" width="80px" height="80px"></td>
		       <td width="300px">${cart.sku_mch }</td>
		       <td>
