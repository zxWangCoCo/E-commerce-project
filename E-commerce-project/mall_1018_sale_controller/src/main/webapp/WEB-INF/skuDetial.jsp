...
<body>
	<div class="Dbox">
		<div class="box">
			<div class="left">
				<div class="timg"><img src="upload/image/${obj_sku.spu.shp_tp}" width="300px"></div>
				<div class="timg2">
	...
	<div class="Dbox1">
		<div class="boxbottom">
			...
			<div class="btm">
			${obj_sku.spu.shp_mch }<br>
				<c:forEach items="${obj_sku.list_image }" var="image"> 
					<img src="upload/image/${image.url }" height="150">
				</c:forEach> <br>
				<c:forEach items="${obj_sku.list_av_name }" var="av_name">
					${av_name.shxm_mch }${av_name.shxzh_mch }
				</c:forEach>
			</div>
		</div>
	</div>
